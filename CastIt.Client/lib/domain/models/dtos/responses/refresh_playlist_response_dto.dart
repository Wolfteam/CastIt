...
@freezed
sealed class RefreshPlayListResponseDto with _$RefreshPlayListResponseDto {
  factory RefreshPlayListResponseDto({required int id, required bool wasDeleted}) = _RefreshPlayListResponseDto;
