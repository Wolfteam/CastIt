...
class PlayerSettingsCard extends StatelessWidget {
        ...
        children: [
          Row(
            children: <Widget>[
              ...
              Container(margin: const EdgeInsets.only(left: 5), child: Text(i18n.playerSettings, style: textTheme.titleLarge)),
            ],
          ),
          Padding(
            padding: const EdgeInsets.only(top: 5),
            child: Text(i18n.changeAppBehaviour, style: const TextStyle(color: Colors.grey)),
          ),
          BlocBuilder<SettingsBloc, SettingsState>(
            builder:
                (context, state) => switch (state) {
                  SettingsStateLoadingState() => const SizedBox.shrink(),
                  SettingsStateLoadedState() => InkWell(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Align(
                                ...
                                child: Text(state.castItUrl, style: theme.textTheme.bodySmall),
                              ),
                            ),
                          ],
                        ),
                  ...
                  SettingsStateLoadedState() =>
                    !state.isConnected
                        ...
                        : CommonDropdownButton<WebVideoQualityType>(
                          ...
                          minItemHeight: 64,
                          values:
                              WebVideoQualityType.values.map((e) => TranslatedEnum(e, '${getWebVideoQualityValue(e)}p')).toList(),
                          currentValue: state.webVideoQuality,
                          onChanged:
                              (newValue, _) => _updateServerSettings(context, state.copyWith.call(webVideoQuality: newValue)),
                        ),
                },
          ),
          BlocBuilder<SettingsBloc, SettingsState>(
                  ...
                  SettingsStateLoadedState() =>
                    !state.isConnected
                        ...
                        : SwitchListTile(
                          ...
                          onChanged:
                              (newValue) => _updateServerSettings(context, state.copyWith.call(playFromTheStart: newValue)),
                        ),
                },
          ),
          BlocBuilder<SettingsBloc, SettingsState>(
                  ...
                  SettingsStateLoadedState() =>
                    !state.isConnected
                        ...
                        : SwitchListTile(
                          ...
                          onChanged:
                              (newValue) =>
                                  _updateServerSettings(context, state.copyWith.call(playNextFileAutomatically: newValue)),
                        ),
                },
          ),
          BlocBuilder<SettingsBloc, SettingsState>(
                  ...
                  SettingsStateLoadedState() =>
                    !state.isConnected
                        ...
                        : SwitchListTile(
                          ...
                          onChanged:
                              (newValue) => _updateServerSettings(context, state.copyWith.call(forceVideoTranscode: newValue)),
                        ),
                },
          ),
          BlocBuilder<SettingsBloc, SettingsState>(
                  ...
                  SettingsStateLoadedState() =>
                    !state.isConnected
                        ...
                        : SwitchListTile(
                          ...
                          onChanged:
                              (newValue) => _updateServerSettings(context, state.copyWith.call(forceAudioTranscode: newValue)),
                        ),
                },
          ),
          BlocBuilder<SettingsBloc, SettingsState>(
  ...
  Future<void> _showConnectionDialog(BuildContext context, String title, String currentCastIt) async {
    await showModalBottomSheet(
      ...
      builder: (_) => ChangeConnectionBottomSheetDialog(currentUrl: currentCastIt, title: title, icon: Icons.link),
    );
  }
}
