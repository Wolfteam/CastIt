...
namespace CastIt.Server.Interfaces
{
    public interface IAppWebServer : IDisposable
    {
        ...
        void Init(string previewPath, string subtitlesPath, IViewForMediaWebSocket view, CancellationToken cancellationToken);
        void Init(string previewPath, string subtitlesPath, CancellationToken cancellationToken);
