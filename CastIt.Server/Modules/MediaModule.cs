        ...
        protected override async Task OnRequestAsync(IHttpContext context)
        {
            ...
            try
            {
                ...
                if (isVideoFile || isHls)
                {
                    ...
                    _logger.Info($"{nameof(OnRequestAsync)}: Handling request for video file with options = {JsonConvert.SerializeObject(options)}");
                ...
                else
                {
                    ...
                    _logger.Info($"{nameof(OnRequestAsync)}: Handling request for music file with options = {JsonConvert.SerializeObject(options)}");
