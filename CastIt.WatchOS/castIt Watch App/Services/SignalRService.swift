...
class SignalRService {
    ...
    // Playlists
    // Align with ClientApp: list/subscription payloads use IGetAllPlayListResponseDto (PlaylistSummary)
    ...
    func play(playListId: Int, fileId: Int) {
        connection.invoke(method: "Play", playListId, fileId, false, false) { error in } // Assuming (playListId, fileId, force, fileOptionsChanged)
    }
