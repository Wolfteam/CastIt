...
namespace CastIt.ViewModels.Dialogs
{
    ...
    public abstract class BaseDialogViewModelResult<TResult> : BaseViewModelResult<TResult>
    {
        #region Members
        private string _title;
        private string _contentText;
    ...
    public abstract class BaseDialogViewModelResult<TParameter, TResult> : BaseViewModelResult<TParameter, TResult>
    {
        #region Members
        private string _title;
        private string _contentText;
